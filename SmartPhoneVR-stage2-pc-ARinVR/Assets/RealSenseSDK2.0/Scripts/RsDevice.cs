...
public class RsDevice : RsFrameProvider
{
    ...
    void OnEnable()
    {
        ...
        DeviceConfiguration.Profiles = ActiveProfile.Streams.Select(RsVideoStreamRequest.FromProfile).ToArray();
         ...
         ActiveProfile.Device.Sensors[1].Options[Option.Exposure].Value = 600.0f;
         ActiveProfile.Device.Sensors[1].Options[Option.WhiteBalance].Value = 6000.0f;
        ActiveProfile.Device.Sensors[1].Options[Option.Gain].Value = 100.0f; ;
