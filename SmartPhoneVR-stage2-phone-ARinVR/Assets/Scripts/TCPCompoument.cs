...
public class TCPCompoument : MonoBehaviour
{
    ...
    Data_Transform data_transform = new Data_Transform(CLIENT_NAME.CN_ANDROID_1, DATA_NAME.DT_ROTATE);
    ...
    void Update()
    {
        ...
        if (myTCP.socketReady == true)
        {
            ...
            //Vector3 translation = cube.transform.position;
    ...
    void OnGUI()
    {
        ...
        //         {
        //             Data_TEST test = new Data_TEST(CLIENT_NAME.CN_ANDROID_1, DATA_NAME.DN_TEST);
        // 
        //             test.value[0] = 1.1f;
        //             test.value[1] = 2.1f;
        //             test.value[2] = 3.1f;
